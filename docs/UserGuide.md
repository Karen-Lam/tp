...
* You may use more than one filter at once.
* If you indicate both Start and End Timing, this function will return you all Events starting or ending within
your given Timings.
* If you indicate Start Timing only, this function will return you all Events starting after the indicated Timing.
* If you indicate End Timing only, this function will return you all Event starting or ending from the current time to
your given End Timing.

Example: `event add na/Technical Interview st/20/03/2023 1400` returns all events with the name Technical
Interview and starting after 20 March 2023, 2pm.
